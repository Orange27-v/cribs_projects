...
class _VerificationBannerState extends State<VerificationBanner> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isNinVerified = agent?.isNinVerified ?? false;
    final bool isBvnVerified = agent?.isBvnVerified ?? false;
    ...
    if (!isNinVerified && !isBvnVerified) {
      message =
          'Verify your NIN and BVN to unlock all features and gain trust from users';
    } else if (isNinVerified && !isBvnVerified) {
      message =
          'Great! Your NIN is verified. Now verify your BVN to complete your profile';
    } else {
      message =
          'Verify your BVN and NIN to unlock all features and gain trust from users';
    }
