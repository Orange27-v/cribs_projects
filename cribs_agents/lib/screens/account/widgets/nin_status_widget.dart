...
class NinStatusWidget extends StatelessWidget {
  final Map<String, dynamic> responsePayload;
  final VoidCallback? onRetry;

  const NinStatusWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final String message =
        responsePayload['message'] ?? 'NIN verification status unknown.';
    ...
    return CardContainer(
      child: Column(
        ...
        children: [
          ...
          Text(
            'NIN Verification Status: $displayStatus',
