...
import 'package:cribs_arena/screens/auth/signup_screen.dart';
...
class _EmailVerificationScreenState extends State<EmailVerificationScreen> {
  ...
  void _handleVerification() async {
    ...
    try {
      final response = await _verificationService.verifyEmail(
        email: widget.email,
        code: code,
      );
  ...
  void _handleResendCode() async {
    ...
    try {
      final response = await _verificationService.resendCode(
        email: widget.email,
      );
