import 'dart:async';
import 'package:cribs_arena/screens/auth/forgot_password_screen.dart';
...
class _PasswordResetVerificationScreenState
  ...
  void _handleVerification() async {
    ...
    try {
      final response = await _passwordResetService.verifyResetCode(
        widget.email,
        code,
      );
  ...
  void _handleResendCode() async {
    ...
    try {
      final response = await _passwordResetService.sendResetCode(widget.email);
