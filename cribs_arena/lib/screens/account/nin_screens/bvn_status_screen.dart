...
import 'package:cribs_arena/services/bvn_service.dart';
import 'package:cribs_arena/screens/account/widgets/pending_status_widget.dart';
import 'package:cribs_arena/screens/account/widgets/bvn_status_widget.dart';
...
class _BvnStatusScreenState extends State<BvnStatusScreen> {
  ...
  Future<void> _refreshUserProfile() async {
    try {
      debugPrint("Refreshing user profile after BVN verification...");
