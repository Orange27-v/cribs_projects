...
// Const TextStyles
const TextStyle kAuthBodyTextStyle =
    TextStyle(fontSize: 14, color: Colors.black87);
const TextStyle kOtpResendTextStyle =
    TextStyle(color: Color(0xFF0066CC), fontWeight: FontWeight.bold);
const TextStyle kAppBarTextStyle =
    TextStyle(color: kPrimaryColor, fontSize: 12);
const TextStyle kBookingTitleStyle =
    TextStyle(color: kPrimaryColor, fontSize: 24, fontWeight: FontWeight.bold);
const TextStyle kBookingSubTitleStyle =
    TextStyle(color: kPrimaryColor, fontSize: 18, fontWeight: FontWeight.w500);
const TextStyle kPayButtonTextStyle =
    TextStyle(color: kWhite, fontWeight: FontWeight.bold, fontSize: 16);
const TextStyle kConfirmationTitleStyle =
    TextStyle(color: kPrimaryColor, fontSize: 24, fontWeight: FontWeight.bold);
const TextStyle kConfirmationSubTitleStyle =
    TextStyle(color: kPrimaryColor, fontSize: 18, fontWeight: FontWeight.w500);
const TextStyle kConfirmationDateStyle =
    TextStyle(color: kPrimaryColor, fontSize: 20, fontWeight: FontWeight.bold);
const TextStyle kConfirmationTimeStyle =
    TextStyle(color: kPrimaryColor, fontSize: 18, fontWeight: FontWeight.bold);
const TextStyle kReturnToFeedButtonStyle =
    TextStyle(color: kWhite, fontSize: 16, fontWeight: FontWeight.bold);
const TextStyle kCalendarTitleStyle =
    TextStyle(color: kPrimaryColor, fontSize: 22, fontWeight: FontWeight.bold);
const TextStyle kCalendarSubTitleStyle = TextStyle(color: kGrey, fontSize: 14);
const TextStyle kCalendarInfoTextStyle =
    TextStyle(color: kPrimaryColor, fontSize: 10);
const TextStyle kContinueButtonTextStyle =
    TextStyle(color: kWhite, fontSize: 16, fontWeight: FontWeight.bold);
const TextStyle kPrimaryColorBoldDefaultTextStyle =
    TextStyle(color: kPrimaryColor, fontWeight: FontWeight.bold);
const kDialogTitleStyle =
    TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: kBlack);
...
// Input Decorations
const InputDecoration kPhoneFieldInputDecoration = InputDecoration(
  labelText: kSignupPhoneNumberLabel,
  labelStyle:
      TextStyle(color: kBlack54, fontSize: 16, fontWeight: FontWeight.w500),
  hintText: 'Phone Number',
  hintStyle: TextStyle(color: kGrey400, fontSize: 16),
