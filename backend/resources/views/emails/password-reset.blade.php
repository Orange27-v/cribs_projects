                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin: 0 0 24px 0;">
                                <tr>
                                    <td style="background-color: #f6f8fa; border: 1px solid #e1e4e8; border-radius: 6px; padding: 24px; text-align: center;">
                                        <div style="font-size: 11px; text-transform: uppercase; letter-spacing: 0.5px; color: #586069; margin-bottom: 8px;">Verification code</div>
                                        <div style="font-size: 32px; font-weight: 600; color: #24292e; letter-spacing: 4px; font-family: 'Courier New', monospace;">{{ $resetCode }}</div>
                                    </td>
                                </tr>
                            </table>
