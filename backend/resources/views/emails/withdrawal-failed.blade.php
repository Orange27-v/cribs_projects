                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <table cellpadding="0" cellspacing="0" style="margin: 0 0 24px 0;">
                                <tr>
                                    <td
                                        style="background-color: #fff5f5; border: 1px solid #fed7d7; border-radius: 3px; padding: 4px 12px;">
                                        <span
                                            style="font-size: 11px; font-weight: 600; color: #c53030; text-transform: uppercase; letter-spacing: 0.5px;">Withdrawal
                                            Failed</span>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p
                                style="margin: 0 0 16px 0; font-size: 14px; color: #c53030; background-color: #fff5f5; padding: 12px; border-radius: 6px;">
                                <strong>Reason:</strong> {{ $withdrawalData['reason'] }}
                            </p>

                            <p style="margin: 0 0 16px 0; font-size: 14px; color: #586069;">
                                We have reversed the transaction, and the funds have been credited back to your wallet.
                            </p>
                                ...
                                <tr>
                                    <td
                                        ...
                                        <div style="font-size: 32px; font-weight: 600; color: #24292e;">
                                            ₦{{ number_format($withdrawalData['amount'], 2) }}</div>
                                    </td>
                                </tr>
                            </table>
