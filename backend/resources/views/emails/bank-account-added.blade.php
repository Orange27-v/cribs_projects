...
<head>
    ...
    <title>New Bank Account Linked</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 8px 0; font-size: 15px; color: #586069;">
                                A new bank account has been successfully linked to your Cribs Arena wallet.
                            </p>
                            ...
                            <table cellpadding="0" cellspacing="0" style="margin: 0 0 24px 0;">
                                <tr>
                                    <td
                                        style="background-color: #ECFDF5; border: 1px solid #10B981; border-radius: 3px; padding: 4px 12px;">
                                        <span
                                            style="font-size: 11px; font-weight: 600; color: #047857; text-transform: uppercase; letter-spacing: 0.5px;">Account
                                            Linked</span>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding: 20px;">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="padding: 8px 0; font-size: 13px; color: #586069;">Bank Name
                                                </td>
                                                <td
                                                    style="padding: 8px 0; font-size: 13px; color: #24292e; text-align: right;">
                                                    {{ $accountData['bankName'] }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    style="padding: 8px 0; font-size: 13px; color: #24292e; text-align: right;">
                                                    {{ $accountData['accountName'] }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; font-size: 13px; color: #586069;">Date Linked
                                                </td>
                                                <td
                                                    style="padding: 8px 0; font-size: 13px; color: #24292e; text-align: right;">
                                                    {{ date('Y-m-d H:i:s') }}</td>
                            ...
                            <p style="margin: 0 0 16px 0; font-size: 14px; color: #586069;">
                                If you did not link this account, please contact our support immediately.
                            </p>
