                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 8px 0; font-size: 15px; color: #586069;">
                                Good news! Your withdrawal has been successfully processed and sent to your bank
                                account.
                            </p>
                            ...
                            <table cellpadding="0" cellspacing="0" style="margin: 0 0 24px 0;">
                                <tr>
                                    <td
                                        style="background-color: #f0fff4; border: 1px solid #c6f6d5; border-radius: 3px; padding: 4px 12px;">
                                        <span
                                            style="font-size: 11px; font-weight: 600; color: #2f855a; text-transform: uppercase; letter-spacing: 0.5px;">Withdrawal
                                            Successful</span>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p style="margin: 0 0 16px 0; font-size: 14px; color: #586069;">
                                If you did not receive these funds, please check with your bank or contact our support
                                team.
                            </p>
